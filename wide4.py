...
class Wide4(nn.Module):

    def __init__(self, args):
        super(Wide4, self).__init__()
        self.user_num = 52643
        self.item_num = 91599
        ...
        self.feature = nn.Sequential(
            nn.Conv2d(1, 16, kernel_size=(1, 2), stride=2),
            nn.Conv2d(16, 16, kernel_size=(1, 2), stride=2),
            nn.Conv2d(16, 16, kernel_size=(1, 2), stride=2),
            nn.Conv2d(16, 16, kernel_size=(1, 2), stride=2),
            nn.Conv2d(16, 16, kernel_size=(1, 2), stride=2),
        )
    ...
    def predict(self, users):
        ...
        u_features = u_features.view(u_shape[0], 1, u_shape[1])
        i_features = self.get_features(items_embedding)
        i_shape = i_features.shape
        i_features = i_features.view(1, i_shape[0], i_shape[1])
